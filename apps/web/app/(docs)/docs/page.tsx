...
import { ArrowRight, Code2, Key, Shield, Activity, Zap } from "lucide-react";
import { Button } from "@/components/ui/button";

export default function DocsPage() {
  return (
    <div className="prose-headings:text-on-surface prose-p:text-on-surface-variant space-y-12">
      <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          { title: "Quickstart", desc: "Get up and running in 5 minutes with a simple API call.", icon: Zap, href: "/docs/quickstart" },
          { title: "API Reference", desc: "Complete endpoint reference with request/response schemas.", icon: Code2, href: "/docs/api-reference" },
          { title: "Authentication", desc: "Learn about API key authentication and session management.", icon: Key, href: "/docs#authentication" },
